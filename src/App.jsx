...
async function handleUpload() {
  ...
  try {
    ...
    const photoRef = ref(
      storage,
      `profilePhotos/${user.uid}/${Date.now()}_${compressedFile.name}`
    );

    const uploadTask = uploadBytesResumable(photoRef, compressedFile);
        ...
        <div style={{ 
          ...
          {currentChatFriend ? (
            ...
            <div style={{
              ...
              <p>This chatting app is created by Mr Divyanshu Pandey</p>
            </div>
          )}
        </div>
