...
// --- Chat Window with delivered, typing, password-protected chat support ---
const ChatWindow = ({
  currentUser,
  activeChat,
  globalTheme,
    ...
    <div className={`flex-1 flex flex-col bg-white dark:bg-gray-900`} style={wallpaper ? {backgroundImage: `url(${wallpaper})`, backgroundSize: 'cover'} : {}}>
      <div className="bg-white dark:bg-gray-800 border-b dark:border-gray-700 p-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 relative">
          ...
          {showMenu && (
            <div className="absolute right-0 top-10 bg-white dark:bg-gray-800 shadow rounded z-50 py-1 min-w-[220px]">
...
// --- Settings (change password, chat passwords) ---
const Settings = ({ onAbout, onLogout, chatPasswords, setChatPasswords }) => {
  ...
  // For demo purposes, chat password management is in chat menu, not here.
        ...
        {changePwModal && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 px-6 py-8 rounded-lg shadow-lg max-w-sm w-full">
              ...
              />
              <button className="w-full bg-blue-500 text-white py-2 rounded" onClick={handleChangePassword}>Save</button>
              <button className="w-full mt-2 bg-gray-300 text-gray-800 py-2 rounded" onClick={() => setChangePwModal(false)}>Cancel</button>
            </div>
          </div>
        )}
      </div>
